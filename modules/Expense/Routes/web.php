    ...
    Route::domain($current_hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::prefix('expenses')->group(function () {
                ...
                Route::get('records/currentbalance', 'ExpenseController@currentBalance');
                Route::get('records/flowfinance', 'ExpenseController@recordsfromflowfinance');
                Route::get('records/flowfinancerigth', 'ExpenseController@recordsfromflowfinancerigth');
