<?php
    ...
    class ServiceData
    {
        ...
        public function service2($type, $number)
        {
            try {          
                $res_data = [];
                if ($type === 'ruc') {
                    $res = $this->client->request('GET', "https://api.apis.net.pe/v1/ruc?numero=$number");
                    ...
                    $data = $response;
                        ...
                        $province_id = null;
                        $district_id = null;
                        $department_id = $data['ubigeo']  != '-' ? $data['ubigeo'][0] . $data['ubigeo'][1]:$data['ubigeo'];
                        $province_id = $data['ubigeo']  != '-' ? $data['ubigeo'][0] . $data['ubigeo'][1] . $data['ubigeo'][2] . $data['ubigeo'][3]  : $data['ubigeo'];
                        $district_id = $data['ubigeo']  != '-' ? $data['ubigeo'][0] . $data['ubigeo'][1] . $data['ubigeo'][2] . $data['ubigeo'][3] . $data['ubigeo'][4] . $data['ubigeo'][5] :$data['ubigeo'];
                        $address = $data['direccion'];
                        $res_data = [
                            'name' => $data['nombre'],
                            'trade_name' => '',
                    ...
                    $res = $this->client->request('GET', "https://api.apis.net.pe/v1/dni?numero=$number");
                    $response = json_decode($res->getBody(), true);
                    $data = $response;
                        $address = '';
                        $department_id = null;
                        $province_id = null;
                        $district_id = null;
                        $department_id = $data['ubigeo'] ;
                        $province_id = $data['ubigeo']  ;
                ...
                return response()->json([
					'success' => false,
					'message' => 'El número de RUC ingresado no existe. Detalles: '
				], 200);
            }
        }
