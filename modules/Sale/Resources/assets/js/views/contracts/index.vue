            ...
            <div class="card-body">
                <data-table :resource="resource">
                    <tr slot="heading">
                        ...
                        <th class="text-right">Generar</th>
                    ...
                    <tr slot-scope="{ index, row }" :class="{ anulate_color : row.state_type_id == '11' }">
                        ...
                        <td class="text-right">
                            ...
                            <a type="button" @click.prevent="clickCreate(row.id,true)" class="btn waves-effect waves-light btn-xs btn-info" >Nota de<br> Venta</a>
                        </td>
                        <!-- <td class="text-right">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clickCreate(id = '') {
                location.href = `/sale-notes/create/${id}_`
            }
        }
    }
</script>
