    ...
    <div>
        ...
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                <el-table :data="currentTableData" :default-sort="{ prop: 'date_of_payment', order: 'ascending' }"
                    :summary-method="getSummaries" show-summary style="width: 100%" @sort-change="changeTableSort">

                    <el-table-column label="Concepto" prop="person_name" sortable> <!--label=Adquiriente-->
                    ...
                    <el-table-column label="Descripcion" prop="document_type_description" sortable> <!--label="Documento/Transacción"-->
                        <template slot-scope="scope">
                            <span>
                    ...
                    <el-table-column :formatter="MonedaFormater" label="S/" prop="balance">
                    </el-table-column>

                </el-table>

                <div>
                    <el-pagination :current-page.sync="currentPage" :page-size="itemsPerPage" :total="records.length"
