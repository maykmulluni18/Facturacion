<template>
    <el-dialog title="Exportar Listado de Insumos" :visible="showDialog" @close="close" class="dialog-import">
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                window.open(`/${this.resource}/export/?type_doc=recipesub&${query}`, '_blank');
