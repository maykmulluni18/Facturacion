        ...
        Route::domain($hostname->fqdn)->group(function () {
            Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
                ...
                Route::prefix('reports')->group(function () {
                    ...
                    Route::get('inventory1', 'ReportInventory1Controller@index')->name('reports.inventory1.index');
                    Route::get('inventory2', 'ReportInventory2Controller@index')->name('reports.inventory2.index');
                    Route::get('inventory3', 'ReportInventory3Controller@index')->name('reports.inventory3.index');
