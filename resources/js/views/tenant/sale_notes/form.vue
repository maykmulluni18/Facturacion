    ...
    methods: {
        ...
        async isUpdate() {
            if(this.id.includes("_")){
                console.log("is contract ",this.id);
                this.id = this.id.replace("_","")
                await this.$http.get(`/contracts/record/${this.id}`)
                    .then(response => {
                        this.form.items = response.data.data.contract.items;
                        this.form.customer_id = response.data.data.contract.customer_id;
                        this.form.date_of_issue = response.data.data.contract.date_of_issue;
                        this.form.due_date = response.data.data.contract.date_of_due;
                        this.form.seller_id = response.data.data.contract.seller_id;
