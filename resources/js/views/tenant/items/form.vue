            ...
            <el-tabs v-model="activeName">
                <el-tab-pane class
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                               <input type="checkbox" size="2" id="insumos" value="insumos" v-model="is_supplies">
                        ...
                        <div class="col-md-3" v-if="is_supplies == false">
                        ...
                        <div class="col-md-3" v-if="is_supplies == true">
                            <div :class="{'has-danger': errors.model}"
                                 class="form-group">
                                <label class="control-label">Modelo</label>
                                <el-input v-model="form.model"
                                          dusk="model" disabled></el-input>
                                <small v-if="errors.model"
                                       class="form-control-feedback"
                                       v-text="errors.model[0]"></small>
                            </div>
                        ...
                        <div class="col-md-3" v-if="is_supplies == true">
                            <div :class="{'has-danger': errors.unit_type_id}"
                                ...
                                <el-select v-model="form.unit_type_id"
                                           dusk="unit_type_id">
                                    <el-option key="NIU" label="Unidades" value="NIU"></el-option>
                                    <el-option key="KGM" label="Kilos" value="KGM"></el-option>
                                </el-select>
                                <small v-if="errors.unit_type_id"
                                       class="form-control-feedback"
                                       v-text="errors.unit_type_id[0]"></small>
                        ...
                        <div class="col-md-3" v-if="is_supplies == 1">
                            <div :class="{'has-danger': errors.sale_unit_price}"
                                 class="form-group">
                                <label class="control-label">Precio Unitario <span class="text-danger">*</span></label>
                                <el-input v-model="form.sale_unit_price"
                                          dusk="sale_unit_price"
                                          :value="1" disabled></el-input>
                                <small v-if="errors.sale_unit_price"
                                       class="form-control-feedback"
                                       v-text="errors.sale_unit_price[0]"></small>
                            </div>
...
this.activeName =  'first'
            ...
            if (this.recordId) {
                await this.$http.get(`/${this.resource}/record/${this.recordId}`)
                    .then(response => {
                        ...
                        this.is_supplies = this.form.model == "Insumos" ? true:false;
        ...
        async submit() {
            ...
            if(this.is_supplies) {
                if(!this.form.category_id) return this.$message.error('Debe seleccionar la categoria en la seccionn Atributos');
                if(!this.form.purchase_unit_price) return this.$message.error('Debe ingresar el precio del producto dentro de Compra');
                this.form.sale_unit_price = 1;
                this.form.model = "Insumos";
            }
