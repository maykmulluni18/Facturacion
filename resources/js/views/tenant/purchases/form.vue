<template>
    <div class="card mb-0 pt-2 pt-md-0">
        ...
        <purchase-form-supplies :currency-type-id-active="form.currency_type_id"
                            :showDialog.sync="showDialogAddSupplies"
                            @add="addRow"></purchase-form-supplies>
...
import PurchaseFormSupplies from './partials/supplies.vue'
...
export default {
    ...
    components: {PurchaseFormItem, PersonForm, PurchaseOptions, SeriesForm,PurchaseFormSupplies},
    ...
    methods: {
        ...
        addRow(row) {
            this.form.items.push(row) // aca se agregan los productos nuevos
            this.calculateTotal()
        },
        ...
        closeSupplie(){
            location.href = '/reports/inventory1'
        },
        async submit() {
