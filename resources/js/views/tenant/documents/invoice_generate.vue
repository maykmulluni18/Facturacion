                            ...
                            <div class="card-body p-2 border-top">
                                <div class="col-12 py-2 px-0">
                                    <div class="row no-gutters">
                                        <div class="col-10">¿Es comprobante de contingenciasdbksf?</div>
                                        <div class="col-2">
...
export default {
    ...
    methods: {
        ...
        calculateTotal() {
            ...
            this.form.total_taxes = total_igv != 0 && total_isc != 0 && total_plastic_bag_taxes !=0 ?  _.round(total_igv + total_isc + total_plastic_bag_taxes, 2) :0 ;
