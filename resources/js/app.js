...
Vue.component('tenant-supplies-index', require('./views/tenant/supplies/index.vue')); // supplies - insumos
Vue.component('tenant-recipescosts-index', require('./views/tenant/recipescosts/index.vue')); //recipescosts  - recetas y costeos
Vue.component('tenant-orderschedule-index', require('./views/tenant/orderschedule/index.vue')); // orderschedule - caja de pedidos


Vue.component('tenant-smallbox-index', require('./views/tenant/smallbox/index.vue')); // smallbox - caja chica
Vue.component('tenant-generalbox-index', require('./views/tenant/generalbox/index.vue')); // generalbox - caja general
...
Vue.component('tenant-inventory1-report', require('../../modules/Inventory/Resources/assets/js/inventory1/reports/index.vue'));
Vue.component('tenant-inventory2-report', require('../../modules/Inventory/Resources/assets/js/inventory2/reports/index.vue'));
Vue.component('tenant-inventory3-report', require('../../modules/Inventory/Resources/assets/js/inventory3/reports/index.vue'));
//
...
Vue.component('tenant-finance-flowfinance-index', require('@viewsModuleFinance/flowfinance/index.vue')); // flow finance - fujo financiero
Vue.component('tenant-finance-statewinlose-index', require('@viewsModuleFinance/statewinlose/index.vue')); // state win lose - estado de ganancia y perdida
Vue.component('tenant-finance-breakpointmonth-index', require('@viewsModuleFinance/breakpointmonth/index.vue')); // breakpointmonth - punto de equilibrio mensual
Vue.component('tenant-finance-ratiosfinance-index', require('@viewsModuleFinance/ratiosfinance/index.vue')); // breakpointmonth - punto de equilibrio mensual
Vue.component('tenant-finance-trendgraph-index', require('@viewsModuleFinance/trendgraph/index.vue')); // breakpointmonth - punto de equilibrio mensual
