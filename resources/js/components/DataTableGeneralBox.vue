        ...
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                <el-table :data="currentTableData" :default-sort="{ prop: 'date_of_payment', order: 'ascending' }"
                    ...
                    <el-table-column label="Columna 1" prop="person_name" sortable> <!--label=Adquiriente-->
                    ...
                    <el-table-column label="Columna 2" prop="document_type_description" sortable> <!--label="Documento/Transacción"-->
                        <template slot-scope="scope">
                            <span>
