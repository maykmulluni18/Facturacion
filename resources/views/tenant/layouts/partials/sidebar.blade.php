            ...
            <nav id="menu"
                ...
                <ul class="nav nav-main">
                    ...
                    @if(in_array('documents', $vc_modules))
                        ...
                        {{ ($firstLevel === 'generalbox')?'nav-active nav-expanded':'' }}
                        {{ ($firstLevel === 'orderschedule')?'nav-active nav-expanded':'' }}
                        ...
                        {{ ($firstLevel === 'regularize-shipping')?'nav-active nav-expanded':'' }}
                            ...
                            <ul class="nav nav-children"
                                ...
                                @if(in_array('sale_notes', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'newmodules') && ($secondLevel == 'orderschedule')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.orderschedule.index')}}">Agenda de Pedidos</a>
                                    </li>
                                @endif

                                {{-- @if(in_array('sale_notes', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'newmodules') && ($secondLevel == 'generalbox')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.generalbox.index')}}">Caja General</a>
                                    </li>
                                @endif --}}
                    ...
                    @if(in_array('items', $vc_modules))
                        ...
                        {{ ($firstLevel === 'supplies')?'nav-active nav-expanded':'' }}
                        {{ ($firstLevel === 'services')?'nav-active nav-expanded':'' }}
                        {{ ($firstLevel === 'categories')?'nav-active nav-expanded':'' }}
                        {{ ($firstLevel === 'recipescosts')?'nav-active nav-expanded':'' }}
                            ...
                            <ul class="nav nav-children">
                                @if(in_array('items', $vc_module_levels))
                                    <li class="{{($firstLevel === 'items') ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                            href="{{route('tenant.supplies.index')}}">Insumos</a>
                                    </li>
                                @endif
                                @if(in_array('items', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'items') && ($secondLevel == 'recipescosts')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.recipescosts.index')}}">Recetas y Costeos</a>
                                    </li>
                                @endif
                                @if(in_array('items', $vc_module_levels))
                                    <li class="{{ ($firstLevel === 'items')?'nav-active':'' }}">
                    ...
                    @if(auth()->user()->type != 'integrator')
                        ...
                        @if(in_array('inventory', $vc_modules))
                            <li class="nav-parent
                            {{ (in_array($firstLevel, ['inventory', 'moves', 'transfers', 'devolutions', 'extra_info_items', 'inventory-review']) |($firstLevel === 'reports' && in_array($secondLevel, ['kardex', 'inventory','inventory1','inventory2','inventory3', 'valued-kardex'])))?'nav-active nav-expanded':'' }}
                                ">
                                <a class="nav-link"
                                   href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    @endif
                                    @if(in_array('inventory_report', $vc_module_levels))
                                        <li class="nav-parent {{(($firstLevel === 'inventory_report') ) ? 'nav-active' : ''}}">
                                            <a class="nav-link" href="#">Repor. Inventario Secund.</a>
                                               
                                            <ul class="nav nav-children">
                                                @if(in_array('inventory_report', $vc_module_levels))
                                                    <li class="{{ ($firstLevel === 'inventory_report' && $secondLevel === 'inventory1')?'nav-active':'' }}">
                                                        <a class="nav-link"
                                                           href="{{route('reports.inventory1.index')}}">Reporte Inventario 1</a>
                                                    </li>
                                                @endif
                                                @if(in_array('inventory_report', $vc_module_levels))
                                                    <li class="{{ ($firstLevel === 'inventory_report' && $secondLevel === 'inventory2')?'nav-active':'' }}">
                                                        <a class="nav-link"
                                                           href="{{route('reports.inventory2.index')}}">Reporte Inventario 2</a>
                                                    </li>
                                                @endif
                                                @if(in_array('inventory_report', $vc_module_levels))
                                                    <li class="{{ ($firstLevel === 'inventory_report' && $secondLevel === 'inventory3')?'nav-active':'' }}">
                                                        <a class="nav-link"
                                                           href="{{route('reports.inventory3.index')}}">Reporte Inventario 3</a>
                                                    </li>
                                                @endif
                                            </ul>
                                        </li>
                        ...
                        <li class="nav-parent {{ $firstLevel === 'finances' && in_array($secondLevel, [
                            ...
                            <ul class="nav nav-children">
                                ...
                                @if(in_array('finances_movements', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'finances') && ($secondLevel == 'movements')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.smallbox.index')}}">Caja Chica</a>
                                    </li>
                                @endif
                                <!--Start Add new Module-->
                                @if(in_array('finances_movements', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'finances') && ($secondLevel == 'flowfinance')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.finances.flowfinance.index')}}">Flujo Financiero</a>
                                    </li>
                                @endif
                                @if(in_array('finances_movements', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'finances') && ($secondLevel == 'breakpointmonth')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.finances.breakpointmonth.index')}}">Punto de Equilibrio - Mensual</a>
                                    </li>
                                @endif
                                @if(in_array('finances_movements', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'finances') && ($secondLevel == 'statewinlose')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.finances.statewinlose.index')}}">Estado de Ganancias y Pérdidas</a>
                                    </li>
                                @endif
                                @if(in_array('finances_movements', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'finances') && ($secondLevel == 'ratiosfinance')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.finances.ratiosfinance.index')}}">Ratios Financieros</a>
                                    </li>
                                @endif
                                @if(in_array('finances_movements', $vc_module_levels))
                                    <li class="{{(($firstLevel === 'finances') && ($secondLevel == 'graphtendence')) ? 'nav-active' : ''}}">
                                        <a class="nav-link"
                                           href="{{route('tenant.finances.trendgraph.index')}}">Graficos de Tendencia</a>
                                    </li>
                                @endif
                                <!--End Add new Module-->
                                @if(in_array('finances_movements', $vc_module_levels))
