...
<body>
<div>
    <h3 align="center" class="title"><strong>Reporte Caja General</strong></h3>
            ...
            <table class="">
                ...
                @foreach($records as $key => $value)
                    <tr>
                        ...
                        <td class="celda">{{$value->category_movement}}</td>
                        <td class="celda">{{$value->half_spent}}</td>
