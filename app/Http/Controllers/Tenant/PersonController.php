...
use App\Models\Tenant\PersonBirthday;
...
class PersonController extends Controller
{
    ...
    public function store(PersonRequest $request)
    {
        ...
        $this->saveBirthdayPerson($person->id,$data['birthday'] ?? "199-01-01");
        return [
            'success' => true,
            'message' => $msg,
            'id' => $person->id
    ...
    public function saveBirthdayPerson($person_id,$date_birthday){
        $params = ["id_person"=>$person_id,"birthday"=>$date_birthday,"id"=>null];
        PersonBirthday::query()->updateOrCreate(['id' => $params['id']], $params);
    }
