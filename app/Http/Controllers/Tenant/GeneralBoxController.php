...
use App\Http\Resources\Tenant\GeneralBoxCollection;
...
use App\Models\Tenant\GeneralBox;
...
use Mpdf\Mpdf;
use App\Exports\GeneralBoxExport;
...
class GeneralBoxController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tenant.generalbox.index', compact('soap_company', 'configuration'));
    }
    ...
    public function columns()
    {
        return [
            ...
            'category_movement' => 'Categoria del Movimiento',
            'half_spent' => 'Medio de Gasto',
    ...
    public function records(Request $request)
    {
        ...
        dd($records); */
        return new GeneralBoxCollection($records->paginate(config('tenant.items_per_page')));
    ...
    private function getRecords($request){
        $records = GeneralBox::whereTypeUser();
    ...
    public function export(Request $request)
    {
        ...
        $items = GeneralBox::whereTypeUser();
        $extradata = [];
        $records =  $items->get();

        return (new GeneralBoxExport())
            ->setExtraData($extradata)
            ->records($records)
            ->download('Reporte_Caja_General_'.Carbon::now().'.xlsx');
    ...
    public function storeWithData($inputs)
    {
        ...
        try {
            ...
            $this->small_box = GeneralBox::query()->updateOrCreate(['id' => $inputs['id']], $data);
            ...
            return [
                ...
                'data' => [
                    ...
                    'description_movement' => $this->small_box->description_movement,
                ],
            ];
