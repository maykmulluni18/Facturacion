<?php
     ...
     * @property category_movement                              $category_movement
     * @property half_spent                                     $half_spent
     ...
     */
    class GeneralBox extends ModelTenant
    {
        use UsesTenantConnection;
        protected $table = 'general_boxs';
        protected $fillable = [
            'id',
         ...
         * @return SaleNote
         */
        public function setGrade(?string $grade): GeneralBox
        {
            $this->grade = $grade;
            return $this;
        }
         ...
         * @return SaleNote
         */
        public function setSection(?string $section): GeneralBox
        {
