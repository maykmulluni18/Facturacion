<?php
     ...
     * @property stock_start                                       $stock_start
     * @property stock_end                                      $stock_end
     * @property unit_price                                      $unit_price
     * @property total                                      $total
     * @property supplies_id                                       $supplies_id
     * @property purchases_id                                       $purchases_id
     ...
     */
    class SuppliesLog extends ModelTenant
    {
        use UsesTenantConnection;
        protected $table ='supplies_logs';
        protected $fillable = [
            'amount',
            'stock_start',
            'stock_end',
