<?php
     ...
     * @mixin ModelTenant
     * @property ratio_tesoreria                              $ratio_tesoreria
     * @property ratio_tesoreria_formula                              $ratio_tesoreria_formula
     ...
     */
    class RatiosFinance extends ModelTenant
    {
        use UsesTenantConnection;
        protected $table ='ratios_general';
        protected $fillable = [
            'ratio_tesoreria',
            'ratio_tesoreria_formula',
            'ratio_liquidez',
            'ratio_liquidez_formula',
            'ratio_rentabilidad_cap_total',
            'ratio_rentabilidad_cap_total_formula',
            'ratio_rentabilidad_general',
            'ratio_rentabilidad_general_formula',
            'ratio_rentabilidad_ventas',
            'ratio_rentabilidad_ventas_formula',
            'created_at',
            'updated_at',
        ];
