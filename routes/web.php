...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::get('items/records2', 'Tenant\ItemController@records2');
            ...
            // supplies - insumos
            Route::get('supplies', 'Tenant\SuppliesController@index')->name('tenant.supplies.index')->middleware('redirect.level');

            Route::post('supplies', 'Tenant\SuppliesController@store');
            Route::post('supplies/updatestock', 'Tenant\SuppliesController@updatestocksupplies');
            Route::post('supplies/savecat', 'Tenant\SuppliesController@saveCat');
            Route::get('supplies/records', 'Tenant\SuppliesController@records');
            Route::get('supplies/columns', 'Tenant\SuppliesController@columns');
            Route::get('supplies/item/tables', 'Tenant\SuppliesController@item_tables');
            Route::get('supplies/tables', 'Tenant\SuppliesController@tables');
            Route::get('supplies/record/{supplie}', 'Tenant\SuppliesController@record');
            Route::delete('supplies/{item}', 'Tenant\SuppliesController@destroy');
            Route::get('supplies/export', 'Tenant\SuppliesController@export')->name('tenant.supplies.export');

            Route::get("inventorysupplies/records","Tenant\SuppliesController@recordsinventorysupplies");

            Route::post("inventory2","Tenant\SuppliesController@storeinventory2");

            Route::post("inventory3","Tenant\SuppliesController@storeinventory3");


            // recipescosts - Recetas y costeos
            Route::get('recipescosts', 'Tenant\RecipesCostsController@index')->name('tenant.recipescosts.index')->middleware('redirect.level');
            Route::post('recipescosts', 'Tenant\RecipesCostsController@store');
            Route::post('recipescosts/duplicated', 'Tenant\RecipesCostsController@duplicate');
            Route::get('recipescosts/records', 'Tenant\RecipesCostsController@records');
            Route::get('subrecipes/records', 'Tenant\RecipesCostsController@recordsSubRecipes');
            Route::get('recipescosts/record/{record}', 'Tenant\RecipesCostsController@record');
            Route::get('recipescosts/export2', 'Tenant\RecipesCostsController@export2')->name('tenant.recipescosts.export');
            Route::delete('recipescosts/{record}', 'Tenant\RecipesCostsController@destroy');
            Route::get('recipescosts/search-items', 'Tenant\RecipesCostsController@searchItems');

            // orderschedule - agenda de pedidos
            Route::get('orderschedule', 'Tenant\OrderScheduleController@index')->name('tenant.orderschedule.index')->middleware('redirect.level');
            Route::post('orderschedule', 'Tenant\OrderScheduleController@store');
            Route::get('orderschedule/records', 'Tenant\OrderScheduleController@records');

            // smallbox - caja chica
            Route::get('smallbox', 'Tenant\SmallBoxController@index')->name('tenant.smallbox.index')->middleware('redirect.level');

            Route::get('smallbox/records', 'Tenant\SmallBoxController@records');
            Route::get('smallbox/filtersdate', 'Tenant\SmallBoxController@filterByDate');
            Route::get('smallbox/saldoActual', 'Tenant\SmallBoxController@getSaldoTotal');
            Route::post('smallbox', 'Tenant\SmallBoxController@store');
            Route::get('smallbox/columns', 'Tenant\SmallBoxController@columns');
            Route::delete('smallbox/{item}', 'Tenant\SmallBoxController@destroy');
            Route::get('smallbox/export', 'Tenant\SmallBoxController@export')->name('tenant.smallbox.export');

            // generalbox - caja general
            Route::get('generalbox', 'Tenant\GeneralBoxController@index')->name('tenant.generalbox.index')->middleware('redirect.level');

            Route::get('generalbox/records', 'Tenant\GeneralBoxController@records');
            Route::post('generalbox', 'Tenant\GeneralBoxController@store');
            Route::get('generalbox/columns', 'Tenant\GeneralBoxController@columns');
            Route::delete('generalbox/{item}', 'Tenant\GeneralBoxController@destroy');
            Route::get('generalbox/export', 'Tenant\GeneralBoxController@export')->name('tenant.generalbox.export');
